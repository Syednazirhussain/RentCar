    ...
    <div class="col-sm-12 col-md-12">
        <div class="col-md-12">
            <div class="form-group">
              ...
              <input type="text" name="name" class="form-control" placeholder="ex. About" value="@if(isset($packages)){{ $packages->name }}@endif">
            </div>
        </div>
    </div>
    ...
    <div class="col-sm-12 col-md-12">
        <div class="col-md-12">
            <div class="form-group">
                ...
                <textarea id="summery" name="summery" rows="10" cols="80"></textarea>
            </div>
        </div>
    </div>
