...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="{{ route('admin.dashboard') }}" class="logo">
      ...
      <span class="logo-lg"><b>Rent</b>Car</span>
    </a>
          ...
          <li class="dropdown user user-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-footer">
                <div class="pull-left">
                  <a href="javascript:void(0)" class="btn btn-default btn-flat">Setting</a>
                </div>
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li>
              <a href="{{ route('admin.vehicles.index') }}"><i class="fa fa-circle-o"></i> Vehicle</a>
            </li>
            <li>
              <a href="{{ route('admin.vendors.index') }}"><i class="fa fa-circle-o"></i> Vehicle Type</a>
            </li>
            <li>
              <a href="{{ route('admin.vehicleSpecifications.index') }}"><i class="fa fa-circle-o"></i> Vehicle Specifiation</a>
            </li>
          </ul>
        </li>
...
<script src="{{ asset('adminlte/js/jquery.validate.min.js') }}"></script>
<script src="{{ asset('adminlte/plugins_new/jasny-bootstrap/js/jasny-bootstrap.min.js') }}"></script>
<script src="{{ asset('adminlte/fileuploader/src/jquery.fileuploader.min.js') }}" type="text/javascript"></script>
<script src="{{ asset('adminlte/fileuploader/js/custom.js') }}" type="text/javascript"></script>
